...
public class AdminProUserController {
    ...
    @RequiresPermissionsDesc(menu={"项目管理" , "人员管理"}, button="新增")
    @PostMapping("/create")
    ...
    @RequiresPermissionsDesc(menu={"项目管理" , "人员管理"}, button="查询")
    @GetMapping("/list")
    ...
    @RequiresPermissionsDesc(menu = {"项目管理", "人员管理"}, button = "删除")
    @PostMapping("/delete")
    ...
    @RequiresPermissionsDesc(menu = {"项目管理", "人员管理"}, button = "编辑")
    @PostMapping("/update")
    ...
    @RequiresPermissionsDesc(menu = {"项目管理", "人员管理"}, button = "详情")
    @GetMapping("/detail")
